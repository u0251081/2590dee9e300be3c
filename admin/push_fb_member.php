...
<table class="table responsive table-bordered">
    <thead>
    <tr>
        <h4 class="widgettitle" style="text-align: center;">可推播FB註冊會員列表</h4>
    </tr>
    <tr>
    ...
    while ($row = mysql_fetch_array($res))
    {
        ...
        <tr align="center">
            ...
            <td width="10%" align="center"><?php echo $row['fb_email']; ?></td>
            <td width="10%" align="center"><?php echo $row['fb_name']; ?></td>
            <td width="5%">
                <?php
                if($row['status'] == 1)
                {
