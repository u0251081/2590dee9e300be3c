...
　               <option value="Early morning">凌晨 00:00 ~ 6:59</option>
            ...
            <thead>
            <tr>
                <th colspan="5"><h4 style="font-family: '微軟正黑體'; font-weight: bold; color: #d62408;">fb導購查詢<br>您目前成功導購數為：<br><?php if(!empty($rows))
                { 
...
<script>
    ...
    var m_id="<?php if(!empty($m_id)){echo $m_id;} ?>";    
     ...
     $.ajax
            ({
                ...
                success:function(data)
                {
                    ...
                    $("#inserttable").html("");
                    $("#inserttable").append(
                             "<tr style='background: #DDDDDD;'><th>編號</th><th>粉專姓名</th>"
                                +"<th>貼文編號</th>"
                                +"<th>點擊時間</th></tr>"
                    ...
                    for(var i=0;i<data.length;i++)
                    {
                        $("#inserttable").append(
                                ...
                                "<tr id='search_data'><td>"+(i+1)+"</td><td>"+data[i]['name']+"</td>"
                                +"<td>"+data[i]['page']+"</td>"
