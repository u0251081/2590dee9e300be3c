...
<div class="widget">
    ...
    <div class="widgetcontent">
        <form class="stdform stdform2" method="post">
            <p>
                <label>會員名稱</label>
                <span class="field"><input type="text" name="m_name" class="input-large" value="<?php echo $row['m_name']; ?>" placeholder="請輸入會員名稱"/></span>
            </p>
            <p>
                <label>電子信箱(帳號)</label>
                <span class="field"><input type="text" name="email" class="input-large" value="<?php echo $row['email']; ?>" placeholder="請輸入電子信箱(帳號)"/></span>
            </p>
            <p>
                <label>密碼</label>
                <span class="field"><input type="password" name="password" class="input-large" value="<?php echo $row['password']; ?>" placeholder="請輸入密碼"/></span>
            </p>
            <p>
                <label>身分證字號</label>
...
<!--            </p>-->
            <p>
                <label>紅利點數</label>
                <span class="field"><input type="text" name="bonus" class="input-large" value="<?php echo $row['bonus'] == "" ? '0' : $row['bonus']; ?>" placeholder="獲得的紅利點數"/></span>
            </p>
            <p>
                <label>獲得分潤</label>
            ...
            <p class="stdformbutton">
                ...
                <input type="button" class="btn btn-default span1" value="返回" onclick="location.href='home.php?url=member'">
            </p>
        </form>
    </div><!--widgetcontent-->
</div><!--widget-->
