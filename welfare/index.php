...
function reback(){
  ...
  location.href='index.php';
    ...
    $("#start_app_btn").click(function()
    {
        ...
        {
            $(this).attr('href','intent://jjl/openwith?url='+url+'&product_id='+pid+'&manager_id='+manager_id+'#Intent;scheme=myapp;package=com.nkfust.firstshop;S.browser_fallback_url=http%3A%2F%2F163.18.62.22/firstshop/index.php?url=app_download;end');
        }
        else if(manager_id != "" && vip_id != "")
        {
            $(this).attr('href','intent://jjl/openwith?url='+url+'&product_id='+pid+'&manager_id='+manager_id+'&vip_id='+vip_id+'#Intent;scheme=myapp;package=com.nkfust.firstshop;S.browser_fallback_url=http%3A%2F%2F163.18.62.22/firstshop/index.php?url=app_download;end');
        }
        else
        {
            $(this).attr('href','intent://jjl/openwith?url='+url+'&product_id='+pid+'#Intent;scheme=myapp;package=com.nkfust.firstshop;S.browser_fallback_url=http%3A%2F%2F163.18.62.22/firstshop/index.php?url=app_download;end');
        }

        //$(this).attr('href','intent://jjl/openwith?url='+url+'&product_id='+pid+'#Intent;scheme=myapp;package=com.nkfust.firstshop;S.browser_fallback_url=http%3A%2F%2Fwww.google.com;end');
        //alert($("#vip_id").text());
